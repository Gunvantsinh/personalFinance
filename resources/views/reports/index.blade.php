    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form name="importCsvForm" id="importCsvForm" method="POST" action="{{ route('importTranscation') }}"
                    class="js-validate" novalidate="novalidate" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong> Allowed File type :</strong>csv,xlsx,xls
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">Import From<span style="color: red;">*</span></label>
                            <div class="col-9">
                                <div class="input-group">
                                    <select class="form-control" name="import_from" required>
                                        <option value="own_format">Our Own Format</option>
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="validatedCustomFile" name="transcationFile"
                                required>
...
@push('page_scripts')
    <script type="text/javascript">
        ...
        $("#datepicker").focusout(function() {
            if ($('#datepicker').val() !== "") {
                window.location.href = window.location.origin + "/transcations?current_month=" + $('#datepicker')
                    .val();
            }
        });

        function ChangeSearch(event,object) {
            window.location.href = window.location.origin + "/transcations?"+event+"=" + object.value
        }
    </script>
@endpush
